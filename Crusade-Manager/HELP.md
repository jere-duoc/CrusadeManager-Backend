...
* The original package name 'Crusade Manager.Crusade Manager' is invalid and this project uses 'Crusade.Manager.Crusade.Manager' instead.
...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/3.4.11/reference/data/nosql.html#data.nosql.mongodb)
* [Spring Reactive Web](https://docs.spring.io/spring-boot/3.4.11/reference/web/reactive.html)
